...
function MODEL_HTML(){
  ...
  <div class="rgrid">
    ...
    ${card("Team values and the line flag","one number, one flag","m",`Each team has one value (Teams tab): the books' rating from past lines (25%), then offense, defense and special teams measured against opponent quality, plus this week's quarterback (75%), and published power rankings at 10% when the refresh can reach them. Each home team adds its own home field: the league's plus half its own edge, capped at a point. When DraftKings' spread sits 4+ points from the resulting fair line, the game is flagged. Since 2016 (each season rated only from earlier ones), the side the values liked covered 55.1% of the time (532 games, 8 of 10 seasons above 50%); in 2021–25, years not used to choose the blend or the threshold, 53.1% (241 games). Team-by-team home field doesn't repeat well from season to season and trimmed the record slightly (55.8% → 55.1%); it's in because it was asked for.`)}
